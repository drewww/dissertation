...
The core of the argument that computer-mediated-communication should simply seek to recreate face-to-face interactions is the notion that face-to-face interaction is a kind of gold standard of human interaction. We cannot imagine an experience (technology-mediated or otherwise) that would measure up to an unmediated face-to-face experience.


This blindness to the potential benefits of mediated communication systems hides the many challenges of face-to-face interaction. Might there be benefits to interactions that blend ``being there'' experiences (mediated or otherwise) and some sort of complementary interface that does not attempt to mimic face-to-face experiences? How might such an experience improve on face-to-face interactions alone? A closer inspection of face-to-face interaction reveals a number of potential ways we might improve on face-to-face interaction:
